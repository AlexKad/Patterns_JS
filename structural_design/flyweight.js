var Task = function(data){
	...
	this.flyweight = FlyweightFactory.get(data.project,
	          data.priority, data.user, data.completed);
...
function TaskCollection(){
	...
	//remember module pattern? it's here
	return {
		add: add,
		get:get, 
		getCount: getCount
...
var projects = ['none','training', 'real-proj'];
var priorities = [1, 2, 3, 4, 5];
var users = ['John', 'Erica', 'Amanda'];
...
console.log('used memory ' + (afterMemory - initialMemory) / 1000000);  //memory in Mb
